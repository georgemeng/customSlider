...
#' }
#' @export
customSlider <- function(inputId, label, min, max, value, step = NULL,
                        ...
                        timezone = NULL, dragRange = TRUE)
{
  ...
  sliderTag <- div(class = "form-group shiny-input-container",
    ...
    tags$div(class='row',
      tags$div(class="col-md-9", style="width: 80%",
      do.call(tags$input, sliderProps)),
      tags$input( id= paste(inputId, "_mapping", sep=""), class="col-md-2 customSliderInput", value=value )
    ),
    singleton(
      tags$head(
        tags$style(type='text/css', ".irs-line-left, .irs-line-mid, .irs-line-right { background: #428bca; }"),
        tags$style(type='text/css', ".irs-min, .irs-max { top: 18px; background: none; }"),
